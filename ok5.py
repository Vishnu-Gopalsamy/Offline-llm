...
def execute_command(user_input):
    # Adjust the temperature for shorter, crisper responses (e.g., 0.5)
        ...
        for line in iter(pipe.readline, ''):
            ...
            if filtered_line:
                ...
                for word in words:
                    ...
                    output_text.update_idletasks()  # Update the GUI with each word
                    window.after(50)  # Delay between words to simulate word-by-word printing
